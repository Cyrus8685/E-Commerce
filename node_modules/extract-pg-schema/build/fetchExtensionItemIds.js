 ...
 */
var fetchExtensionItemIds = function (db) { return __awaiter(void 0, void 0, void 0, function () {
    var cq, extClassOids, tq, extTypeOids, rq, extProcOids;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                cq = _a.sent();
                extClassOids = cq.map(function (_a) {
                    var oid = _a.oid;
                    return oid;
                });
                return [4 /*yield*/, db
            ...
            case 2:
                tq = _a.sent();
                extTypeOids = tq.map(function (_a) {
                    var oid = _a.oid;
                    return oid;
                });
                return [4 /*yield*/, db
            ...
            case 3:
                rq = _a.sent();
                extProcOids = rq.map(function (_a) {
                    var oid = _a.oid;
                    return oid;
                });
                return [2 /*return*/, { extClassOids: extClassOids, extTypeOids: extTypeOids, extProcOids: extProcOids }];
        }
    });
}); };
