...
var extractRange_1 = __importDefault(require("./extractRange"));
...
(0, vitest_1.describe)("extractRange", function () {
    var getKnex = (0, useTestKnex_1.default)()[0];
    (0, useSchema_1.default)(getKnex, "test");
    (0, vitest_1.it)("should extract range values", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, extractRange_1.default)(db, makePgType("some_range"))];
                case 2:
                    result = _a.sent();
                    expected = {
                        name: "some_range",
