...
var extractCompositeType_1 = __importDefault(require("./extractCompositeType"));
...
(0, vitest_1.describe)("extractCompositeType", function () {
    ...
    (0, vitest_1.it)("should extract simplified information", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, extractCompositeType_1.default)(db, makePgType("some_composite_type"))];
                case 2:
                    result = _a.sent();
                    expected = {
    ...
    (0, vitest_1.it)("should fetch column comments", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    db = getKnex();
                    return [4 /*yield*/, db.raw("create type test.some_composite_type as (id integer, name text)")];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, db.raw("comment on column test.some_composite_type.id is 'id column'")];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, (0, extractCompositeType_1.default)(db, makePgType("some_composite_type"))];
                case 3:
    ...
    (0, vitest_1.it)("should handle domains, composite types, ranges and enums as well as arrays of those", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    _a.sent();
                    return [4 /*yield*/, db.raw("create type test.some_composite_type as (\n        d test.some_domain,\n        c test.some_composite,\n        r test.some_range,\n        e test.some_enum,\n        d_a test.some_domain[],\n        c_a test.some_composite[],\n        r_a test.some_range[],\n        e_a test.some_enum[]\n    )")];
                case 5:
                    _a.sent();
                    return [4 /*yield*/, (0, extractCompositeType_1.default)(db, makePgType("some_composite_type"))];
                case 6:
                    result = _a.sent();
                    actual = R.map(R.pick(["name", "expandedType", "type", "isArray"]), result.attributes);
                    expected = [
                        {
                            name: "d",
