...
var extractDomain_1 = __importDefault(require("./extractDomain"));
...
(0, vitest_1.describe)("extractDomain", function () {
    ...
    (0, vitest_1.it)("should extract simplified as well as full information_schema information", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    db = getKnex();
                    return [4 /*yield*/, db.raw("create domain test.some_domain as integer")];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, extractDomain_1.default)(db, makePgType("some_domain"))];
                case 2:
                    result = _a.sent();
                    expected = {
                        name: "some_domain",
