...
var extractView_1 = __importDefault(require("./extractView"));
...
(0, vitest_1.describe)("extractView", function () {
    ...
    (0, vitest_1.it)("should extract simplified as well as full information_schema information", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, extractView_1.default)(db, makePgType("some_view"))];
                case 2:
                    result = _a.sent();
                    expected = {
                        name: "some_view",
    ...
    (0, vitest_1.it)("should fetch column comments", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, db.raw("comment on column test.some_view.id is 'id column'")];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, (0, extractView_1.default)(db, makePgType("some_view"))];
                case 3:
    ...
    (0, vitest_1.it)("should handle domains, composite types, ranges and enums as well as arrays of those", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    _a.sent();
                    return [4 /*yield*/, db.raw("create view test.some_view as select * from test.some_table")];
                case 6:
                    _a.sent();
                    return [4 /*yield*/, (0, extractView_1.default)(db, makePgType("some_view"))];
                case 7:
    ...
    (0, vitest_1.it)("should report the correct source", function () { return __awaiter(void 0, void 0, void 0, function () {
        var db, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    db = getKnex();
                    return [4 /*yield*/, db.raw("create table test.some_table (id integer not null)")];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, db.raw("create view test.some_view as select * from test.some_table")];
                case 2:
