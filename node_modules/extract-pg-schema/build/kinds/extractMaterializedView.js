...
var fakeInformationSchemaColumnsQueryPart_1 = __importDefault(require("./query-parts/fakeInformationSchemaColumnsQueryPart"));
var fakeInformationSchemaViewsQueryPart_1 = __importDefault(require("./query-parts/fakeInformationSchemaViewsQueryPart"));
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [2 /*return*/, __assign(__assign({}, materializedView), { definition: fakeInformationSchemaValue.view_definition, columns: columns, fakeInformationSchemaValue: fakeInformationSchemaValue })];
        }
    });
}); };
exports.default = extractMaterializedView;
