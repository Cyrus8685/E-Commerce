...
var extractEnum_1 = __importDefault(require("./extractEnum"));
...
(0, vitest_1.describe)("extractEnum", function () {
    var getKnex = (0, useTestKnex_1.default)()[0];
    (0, useSchema_1.default)(getKnex, "test");
    (0, vitest_1.it)("should extract enum values", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, (0, extractEnum_1.default)(db, makePgType("some_enum"))];
                case 2:
                    result = _a.sent();
                    expected = {
                        name: "some_enum",
