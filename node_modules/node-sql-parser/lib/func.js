(function (global, factory) {
  ...
  _exports.jsonOrJsonbToSQL = jsonOrJsonbToSQL;
  ...
  function jsonOrJsonbToSQL(jsonb) {
    ...
    return jsonb.map(operator => {
      ...
      return [(0, _util.commonOptionConnector)(op, _expr.exprToSQL, right.expr), (0, _column.asToSQL)(right.as)].filter(_util.hasVal).join(' ');
    }).join(' ');
  }
